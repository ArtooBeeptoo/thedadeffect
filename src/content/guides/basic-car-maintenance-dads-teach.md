...
*   **Connecting the cables (the order is key!):**
    ...
    4.  Black clamp to an unpainted metal surface on the engine block of the dead car (NOT the negative terminal of the dead battery – this avoids sparks near battery gases).
...
*   **Removing the cables (reverse order!):**
    1.  Black clamp from the engine block of the now-started car.
...
*Got a classic dad car maintenance story? We want to hear it! Find us on [X/Twitter](https://x.com/DadEffect).*
